...
Most of these come down to network reality or how 58com serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

58com rate-limits like any public site. job58 already paces
...
Where a surface is gated, job58 reads a cookie or token you supply
...
`job58`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what job58 actually did
